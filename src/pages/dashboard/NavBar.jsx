...
const NavBar = ({ setIsSearchOpen }) => {
  ...
  return (
    <nav className="
      /* Mobile Styles */
      fixed bottom-0 left-0 w-full h-16 bg-gray-950/90 backdrop-blur-md px-4 flex flex-row items-center justify-around z-40
      /* Desktop/Tablet Styles */
      md:top-16 md:left-0 md:w-16 md:h-[calc(100vh-64px)] md:flex-col md:justify-start md:pt-8
    ">
      {navItems.map((item) => {
